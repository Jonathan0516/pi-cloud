...
const packages = [
	...
	{ directory: "packages/env-opensandbox", name: "@earendil-works/pi-env-opensandbox" },
	...
	{ directory: "packages/session-backends/postgres", name: "@earendil-works/pi-session-backend-postgres" },
